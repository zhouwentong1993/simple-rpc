...
import com.wentong.transport.command.ResponseHeader;
...
public class ResponseEncoder extends CommandEncoder {
    ...
    protected void encodeHeader(ChannelHandlerContext channelHandlerContext, Header header, ByteBuf byteBuf) throws Exception {
        ...
        if(header instanceof ResponseHeader) {
            ...
            byteBuf.writeBytes(responseHeader.getResponse() == null ? new byte[0]: responseHeader.getResponse().getBytes(StandardCharsets.UTF_8));
        } else {
